...
def _validate_args(args):
    ...
    if args.sample_steps is None:
        args.sample_steps = 40 if "i2v" in args.task else 30
...
def _parse_args():
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="/h3cstore_ns/ydchen/code/wan_2_1/Wan2.1/video_result_car",
        help="Directory to save the generated image or video.")
    parser.add_argument(
        "--base_seed",
        type=int,
        default=-1,
